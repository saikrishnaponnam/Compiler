...
static const yytype_uint16 yyrline[] =
{
     ...
     207,   211,   212,   216,   241,   247,   251,   252,   253,   259,
     270,   306,   323,   324,   327,   328,   329,   333,   334,   335,
     336,   337,   338,   339,   340,   341,   342,   343,   344,   345,
     346,   347,   348,   352,   365,   377,   381,   385,   400,   401,
     408,   409,   410,   413,   431,   468,   479,   480,   481,   484,
     485,   488,   491,   492,   495,   501,   507,   513,   519,   519,
     533,   534,   537,   537,   580,   582,   583,   586,   591,   603,
     616,   617,   618,   621,   622,   625,   628,   629
};
#endif
...
#line 216 "exp.y" /* yacc.c:1646  */
    {	// ID1s class = ID
												...
												Ctemp=CLookup((yyvsp[-2])->varname);
												if(Ctemp==NULL)
													{printf("%s is not a class\n",(yyvsp[-2])->varname);exit(1);}
												(yyvsp[-2])->cptr=Ctemp;

												struct Classtable *varclass=tempst->cptr;
												while(Ctemp!=NULL)
												{
													if(strcmp(Ctemp->name,varclass->name)==0)
														break;
													Ctemp=Ctemp->parentptr;
												}
												if(Ctemp==NULL)
													{printf("Class %s is not derived from %s\n",(yyvsp[-2])->varname,varclass->name);exit(1);}
...
#line 2284 "y.tab.c" /* yacc.c:1646  */
  ...
  case 81:
#line 337 "exp.y" /* yacc.c:1646  */
    {(yyval) =createtree(0,nodetype_MOD,typeint,NULL,(yyvsp[-2]),(yyvsp[0]),NULL);}
#line 2290 "y.tab.c" /* yacc.c:1646  */
    break;

  case 82:
#line 338 "exp.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[-1]);}
#line 2296 "y.tab.c" /* yacc.c:1646  */
    break;

  case 83:
#line 339 "exp.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]);}
...
#line 2725 "y.tab.c" /* yacc.c:1646  */
  ...
  case 125:
#line 582 "exp.y" /* yacc.c:1646  */
    {arg=0;}
#line 2731 "y.tab.c" /* yacc.c:1646  */
    break;

  case 127:
#line 586 "exp.y" /* yacc.c:1646  */
    {
