...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 19 "exp.y" /* yacc.c:1646  */
    {(yyval) = (yyvsp[0]); printf("Answer : %d\n",evaluate((yyvsp[-1]))); 
						//printf("Prefix\n"); prefix($1);printf("\nPostfix\n"); postfix($1);
						fprintf(target_file, "%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\nBRKP\n",0,2056,0,0,0,0,0,0);
						reg=codegen((yyvsp[-1]),target_file);print(reg,target_file);fprintf(target_file,"INT 10"); 
						exit(1); }
